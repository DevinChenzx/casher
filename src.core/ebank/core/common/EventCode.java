...
public class EventCode {
	...
	public static final String SLA_SERVICENOTFOUND  ="511601";     //数据库返回 错误服务编号或者该服务未开通
	...
	public static final String SP_AMOUNT_VALUEOVER="501607";       //面额小于订单金额,不能进行交易
		public static final String AMOUNT_QUTOR = "501613";          //超过单笔限额	
	public static final String AMOUNT_DAY_QUTOR = "501614";      //超过当日限额
	...
	public static final String JCB_SERVICE_REQUESTSAME        ="501101";    //重复的服务请求 "Please do not use your BACK or RELOAD/REFRESH browser functions or CLOSE your browser while using this service. ");
	...
	public static final String MASTERCARD_SERVERCONNECT       ="601301";    //MASTERCARD MPI 连接错误
	...
	public static final String ORDER_CREATE_ERROR     ="701000"; //订单创建异常
	public static final String ORDER_RESULT_VERFIY_FAILURE     ="701001"; //订单校验失败
