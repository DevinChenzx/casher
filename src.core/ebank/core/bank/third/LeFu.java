...
public class LeFu extends BankExt
  implements BankService
{
  static Logger logger = Logger.getLogger(LeFu.class);
  ...
  private static String redirectURL = "http://epay.gicard.net/LefuPayRedirect";

  private static String nofityURL = "http://epay.gicard.net/LefuPayNotify";
