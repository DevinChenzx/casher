       ...
       <div class="ord_btye"><p >您正在使用即时到账交易：付款后资金直接进入对方账户</p></div>
	    ...
	    <div class="guideye ">
	              <div class="SelectBank"> 
	               <c:if test="${m.cChannelNum>'1'}">
	              	 <div class="moreblkye"><a href="javascript:showCDiv()">全部银行</a></div>
	              	 </c:if>
		               <li id="bb">
			             <input type="radio" name="_channelcode" id="B2C-${m._cchannelcode}" value="${m._cchannelcode}" checked="" onclick="setBankName(1,'${m._cchannelcode}')">
			             <label for="B2C-${m._cchannelcode}"> <img src="images/bank_v3/${m._cchannelcode}_OUT.png"  width="127" height="40" border="0" onclick="javascript:showCDiv()" style="cursor:pointer;"> </label>
			             </li>
		            </div>
	       </div>
