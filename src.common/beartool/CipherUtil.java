...
public class CipherUtil {
	...
	public static void main(String[] args)
	{
		try {
			if(args.length!=3){
				System.out.println("usage: java CipherUtil [encrypt|decrypt] data key");
			}
			if("encrypt".equals(args[0])){
				System.out.println(args[1] +" encrypt by "+args[2]+" is ["+CipherUtil.encryptData(args[1], args[2])+"]");
			}
			if("decrypt".equals(args[0])){
				System.out.println(args[1] +" dencrypt by "+args[2]+" is ["+CipherUtil.encryptData(args[1], args[2])+"]");
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
